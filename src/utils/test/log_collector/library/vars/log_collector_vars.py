...
"""
Log Collector — Module-Specific Variables

Contains all constants, paths, and command templates for log collection
verification from Kubernetes and Slurm cluster nodes.

Common vars (ssh_opts, config names, timeouts) live in the ``omnia_auto``
package and are set via ``omnia_auto.configure()`` in conftest.py.
...
# =============================================================================
# DIRECTORY PATHS (monorepo-relative)
# =============================================================================

# Module root: test/log_collector/ directory (where conftest.py lives)
MODULE_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(
    os.path.abspath(__file__)
)))

# src/utils/ root (parent of test/)
UTILS_ROOT = os.path.dirname(os.path.dirname(MODULE_ROOT))

# Omnia monorepo root
MONOREPO_ROOT = os.path.dirname(os.path.dirname(UTILS_ROOT))
