...
TEST_NAMES: Dict[str, str] = {
    # Functional Tests
    "collection_invocation": "TC-F01: One-Shot Collection Invocation",
    "source_collection": "TC-F02: Source Collection and Warning Accumulation",
    "metadata_synthesis": "TC-F03: Metadata Synthesis and Inclusion",
    "bundle_construction": "TC-F04: Bundle Construction with Deterministic Naming",
    "hash_generation": "TC-F05: Integrity Hash Generation",
    "completion_output": "TC-F06: User-Facing Completion Output",

    # Negative/Error Tests
    "output_not_writable": "TC-E01: Output Directory Not Writable",
    "unreachable_node": "TC-E02: Unreachable Node - Collection Continues with Warning",
    "missing_sources": "TC-E03: Missing Source Files - Warning Emitted",
    "archive_failure": "TC-E04: Archive Generation Failure",

    # Idempotency Tests
    "idempotency": "TC-I01: Collection Command Idempotency",

    # Compatibility Tests
    "curated_mode": "TC-C01: Curated Support Mode - Exclude Temporary/Stale Logs",
    "full_mode": "TC-C02: Full Collection Mode - Include All Logs",

    # Deploy
    "deploy_collect": "Deploy: collect.yml ({tag})",
    "deploy_collect_full": "Deploy: collect.yml (full mode)",
}

# =============================================================================
# LOG MESSAGES (TEST_LOG_MSGS per design doc)
# =============================================================================

TEST_LOG_MSGS: Dict[str, str] = {
    # Playbook deploy
    "playbook_success": "Playbook completed successfully (duration: {duration}s)",
...
# =============================================================================
# ASSERT MESSAGES (TEST_ASSERT_MSGS per design doc)
# =============================================================================
...
TEST_ASSERT_MSGS: Dict[str, str] = {
    ...
    "assert_bundle_name_format": (
        ...
        "omnia_logs_<YYYYMMDD-HHMMSS>.tar.gz\n"
        "Actual: {name}"
    ),
    ...
    "assert_hash_match": (
        "Generated hash should match independent computation.\n"
        "Generated: {generated}\n"
        "Computed:  {computed}"
    ),
